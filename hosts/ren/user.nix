  ...
  programs.autorandr = {
    ...
    profiles =
      ...
      in
      {
        default = {
          fingerprint = {
            eDP-1 = "";
          };
          hooks.postswitch = ''
            xrandr --fb 1920x1080
